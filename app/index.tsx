...
const s = StyleSheet.create({
  ...
  catRowContent: { paddingHorizontal: 16, gap: 8, alignItems: 'center', paddingVertical: 8 },
  catTile: { alignItems: 'center', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 12, backgroundColor: '#fff', minWidth: 64 },
  ...
  inputBox: { borderTopWidth: 1, borderTopColor: T.border, padding: 16, paddingBottom: 32, gap: 8, backgroundColor: T.cream, marginTop: 16 },
  inputRow: { flexDirection: 'row', gap: 8 },
  input: { height: 38, borderWidth: 1, borderColor: T.border, borderRadius: 10, paddingHorizontal: 12, fontSize: 14, backgroundColor: '#fff', color: T.ink },
  gemBtn: { height: 38, paddingHorizontal: 18, backgroundColor: T.ink, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  gemBtnText: { color: '#fff', fontSize: 14, fontWeight: '500' },
});